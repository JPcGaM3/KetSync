...
halves, do not touch the engine — say so instead.
    ...
    ct-prepare.sh    tests/mutation/run-mutation-prepare.sh     63 mutations
...
## Before you say you are done
    ...
    make test       # 66 + 76 + 70 + 67 + 53 + 72 simulator, 16 dispatcher, 125 c2v
    make mutation   # 46 + 58 + 59 + 68 + 47 + 63 engine + 9 dispatcher, all caught
