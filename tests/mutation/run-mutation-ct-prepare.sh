...
ROOT="$(cd "$HERE/../.." && pwd)"
SIM="$ROOT/tests/sim/ct-prepare/run-sim-prepare.sh"
SRC="$ROOT/engines/ct-prepare.sh"
...
mutant "rsh goes back to plain ssh - every question to a production node meets its login shell" \
