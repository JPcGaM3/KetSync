...
ENGINE="${ENGINE:-$ROOT/engines/ct-replica.sh}"   # overridable, the way run-sim.sh is
...
if scenario "109: a conf with one broken line refuses the run instead of running on defaults"; then
